...
class Spot( Base ):
    ...
    def __init__( self, path ):
        ...
        # base constructor
        super().__init__( os.path.join( path, 'spot' ) )
        return
    ...
    def getItem( self, uri, **kwargs ):
        ...
        shortname = self.getMatch( uri, r'_SPOT[\d]_' ).strip( '_' )
        item.common_metadata.platform = common[ 'platform' ] + ' ' + shortname.replace( 'SPOT', '' )
